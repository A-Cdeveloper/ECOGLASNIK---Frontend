...
const ForecastWeather = ({
  ...
  return (
    <div className="flex-1 ">
      <ul className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7 gap-1 opacity-70 h-[65px] overflow-y-auto overflow-x-hidden">
